...
reboot_midnight(){
		...
		if [[ "$currenttime" > "00:00:01" ]] && [[ "$currenttime" < "00:00:15" ]]; then
     			#reboot
			echo "time to reboot"
			echo "system reboot at midnight">>/home/asrlab/RSU_Controller_master/log/system_reboot_$NOW.log
			reboot
   		fi
		...
		if [[ "$currenttime" > "00:05:01" ]] && [[ "$currenttime" < "00:05:03" ]]; then
			...
			echo "DSRC reboot at midnight">>/home/asrlab/RSU_Controller_master/log/system_reboot_$NOW.log
