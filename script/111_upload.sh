...
while read line; do
	...
	echo "oslabTainanBUS"|ssh -J nckucsieos@223.200.250.100:10122 -p 10003 oslab@$line -tt 'sudo systemctl stop middleware.service'
	...
	scp  -P 10003 -o 'ProxyJump nckucsieos@223.200.250.100 -p 10122'  $middleware_path oslab@$line:/home/oslab/RSU_Controller/build/exec/
	echo "oslabTainanBUS"|ssh -J nckucsieos@223.200.250.100:10122 -p 10003 oslab@$line -tt 'sudo systemctl start middleware.service'
