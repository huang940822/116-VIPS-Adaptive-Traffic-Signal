...
#define TSP_REMAINING_DISTANCE_NUM TSP_REMAINING_DISTANCE_MAX / TSP_REMAINING_DISTANCE_INTERVAL
#define TSP_SIGNAL_PHASE_NUM TSP_SIGNAL_PHASE_MAX / TSP_SIGNAL_PHASE_INTERVAL
#define TSP_REMAINING_TIME_NUM TSP_REMAINING_TIME_MAX / TSP_REMAINING_TIME_INTERVAL
...
{
    uint8_t plan_id;
    TSP_adjustment_t entry[TSP_REMAINING_DISTANCE_NUM][TSP_SIGNAL_PHASE_NUM][TSP_REMAINING_TIME_NUM][TSP_TARGET_PHASE_NUM];
...
{
    uint8_t plan_id;
    TSP_driving_recommend_t entry[TSP_REMAINING_DISTANCE_NUM][TSP_SIGNAL_PHASE_NUM][TSP_REMAINING_TIME_NUM][TSP_TARGET_PHASE_NUM];
