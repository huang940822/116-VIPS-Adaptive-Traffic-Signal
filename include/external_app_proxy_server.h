...
#define HEARTBEAT_CHECK_START_OFFSET_S   100    //start checking heartbeat after enter mainloop 100-s
#define HEARTBEAT_CHECK_PERIOD_S     100        //after that, send heartbeat per 100-s
